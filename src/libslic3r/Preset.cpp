...
static std::vector<std::string> s_Preset_print_options {
    ...
    "bridge_acceleration", "first_layer_acceleration", "first_layer_acceleration_over_raft", "default_acceleration", "decel_ratio", "skirts", "skirt_distance", "skirt_height", "draft_shield",
